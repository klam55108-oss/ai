...
const (
	...
	MuseImage                 string = "openrouter.muse-image"
	MAIImage25                string = "openrouter.mai-image-2.5"
	MAIImage25Pro             string = "openrouter.mai-image-2.5-pro"
	MaiImage26                string = "openrouter.mai-image-2.6"
	MaiImage26Flash           string = "openrouter.mai-image-2.6-flash"
	...
	RecraftV4Styles           string = "openrouter.recraft-v4-styles"
	RecraftV4StylesPro        string = "openrouter.recraft-v4-styles-pro"
	RecraftV4StylesProVector  string = "openrouter.recraft-v4-styles-pro-vector"
	RecraftV4StylesVector     string = "openrouter.recraft-v4-styles-vector"
...
var Models = map[string]image.GenerationModel{
	...
	MuseImage: {
		ID:       MuseImage,
		Name:     "OpenRouter – Muse Image",
		Provider: "openrouter",
		APIModel: "meta/muse-image",
		Currency: "USD",
		Pricing: map[string]map[string]float64{
			"default": {"default": 0.000002},
		},
	...
	MaiImage26: {
		ID:       MaiImage26,
		Name:     "OpenRouter – MAI-Image-2.6",
		Provider: "openrouter",
		APIModel: "microsoft/mai-image-2.6",
		Currency: "USD",
		Pricing: map[string]map[string]float64{
			"default": {"default": 0.000038},
		},
		MaxPromptTokens: 4096,
	},
	MaiImage26Flash: {
		ID:       MaiImage26Flash,
		Name:     "OpenRouter – MAI-Image-2.6 Flash",
		Provider: "openrouter",
		APIModel: "microsoft/mai-image-2.6-flash",
		Currency: "USD",
		Pricing: map[string]map[string]float64{
			"default": {"default": 0.000019},
		},
		MaxPromptTokens: 4096,
	},
	GPT5Image: {
	...
	RecraftV4Styles: {
		ID:       RecraftV4Styles,
		Name:     "OpenRouter – Recraft V4 Styles",
		Provider: "openrouter",
		APIModel: "recraft/recraft-v4-styles",
		Currency: "USD",
		Pricing: map[string]map[string]float64{
			"default": {"default": 0.000008},
		},
		MaxPromptTokens: 65536,
	},
	RecraftV4StylesPro: {
		ID:       RecraftV4StylesPro,
		Name:     "OpenRouter – Recraft V4 Styles Pro",
		Provider: "openrouter",
		APIModel: "recraft/recraft-v4-styles-pro",
		Currency: "USD",
		Pricing: map[string]map[string]float64{
			"default": {"default": 0.000024},
		},
		MaxPromptTokens: 65536,
	},
	RecraftV4StylesProVector: {
		ID:       RecraftV4StylesProVector,
		Name:     "OpenRouter – Recraft V4 Styles Pro Vector",
		Provider: "openrouter",
		APIModel: "recraft/recraft-v4-styles-pro-vector",
		Currency: "USD",
		Pricing: map[string]map[string]float64{
			"default": {"default": 0.000029},
		},
		MaxPromptTokens: 65536,
	},
	RecraftV4StylesVector: {
		ID:       RecraftV4StylesVector,
		Name:     "OpenRouter – Recraft V4 Styles Vector",
		Provider: "openrouter",
		APIModel: "recraft/recraft-v4-styles-vector",
		Currency: "USD",
		Pricing: map[string]map[string]float64{
			"default": {"default": 0.000012},
		},
		MaxPromptTokens: 65536,
	},
	RecraftV4Vector: {
