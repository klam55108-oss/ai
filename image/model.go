...
// GenerationModel represents an image generation model with its configuration and capabilities.
//
// Each image provider package publishes its own catalog of these under the name
