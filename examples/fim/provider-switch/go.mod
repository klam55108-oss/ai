module github.com/joakimcarlsson/ai/examples/fim/provider-switch

go 1.25.0

require (
	github.com/joakimcarlsson/ai/fim v0.0.0-00010101000000-000000000000
	github.com/joakimcarlsson/ai/fim/deepseek v0.0.0-00010101000000-000000000000
	github.com/joakimcarlsson/ai/fim/mistral v0.0.0-00010101000000-000000000000
