...
require (
	github.com/joakimcarlsson/ai/agent v0.5.3
	github.com/joakimcarlsson/ai/fim v0.3.0
	...
	github.com/joakimcarlsson/ai/tokens/summarize v0.1.10
	...
	github.com/joakimcarlsson/ai/voice v0.2.10
